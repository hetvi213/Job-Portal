...
public class RegisterPage extends JFrame {
    ...
    public RegisterPage() {
        ...
        JLabel headingLabel = new JLabel("Register Page");
        ...
        // Place register button in the center
        gbc.gridx = 0;
        gbc.gridy = 3;
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    if (success) {
                        ...
                        new LoginPage();  // Redirect to login page after successful registration
                        dispose();
                    } else {
    ...
    public static void main(String[] args) {
        new RegisterPage();  // Start the RegisterPage UI
    }
}
